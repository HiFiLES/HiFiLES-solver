...
public:
  ...
  void rusanov_flux(array<double> &u_l, array<double> &u_r, array<double> &v_g, array<double> &f_l, array<double> &f_r, array<double> &norm, array<double> &fn, double &eig, int n_dims, int n_fields, double gamma);
