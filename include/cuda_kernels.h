...
void calc_artivisc_coeff_gpu_kernel_wrapper(int in_n_eles, int in_n_upts_per_ele, int in_order, int in_ele_type, int in_artif_type, double epsilon0, double s0, double kappa, double* in_disu_upts_ptr, double* in_vandermonde_ptr, double* in_vandermonde2D_ptr, double* concentration_array_ptr, double* out_epsilon_ptr, double* out_sensor_ptr, double* epsilon_global_eles, int* ele2global_ele_code);
