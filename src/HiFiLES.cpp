...
int main(int argc, char *argv[]) {
  ...
  while(i_steps < FlowSol.n_steps) {
      ...
      if(i_steps%FlowSol.plot_freq == 0 || i_steps%FlowSol.restart_dump_freq==0 || i_steps%run_input.diagnostics_freq == 0 || i_steps%run_input.monitor_res_freq==0 || i_steps%run_input.monitor_force_freq == 0){
#ifdef _GPU
