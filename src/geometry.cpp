          ...
          if (found==0)
            {
              ...
              cout << "vlist_boun(0)=" << vlist_bound(0) << " vlist_boun(1)=" << vlist_bound(1) << endl;
              cout << "vlist_boun(2)=" << vlist_bound(2) << " vlist_boun(3)=" << vlist_bound(3) << endl;
