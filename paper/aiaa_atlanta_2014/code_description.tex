...
In this section the main numerical techniques implemented in HiFiLES will be described. In particular, we will empathize the critical role of the selected numerical discretization (Flux Reconstruction Method), and its capability to solve CFD problems using unstructured meshes. 
