...
\begin{center} 
    ...
    \hline
    \end{tabular} 
      \captionof{table}{HiFiLES convergence using different grids and polynomial order. $\times$ / \Checkmark indicates not converged/converged resp.} \label{tab:convergence} 
\end{center}
